package com.agileboot.generator.util;
...
public class VelocityUtils {
    ...
    public static void setSubVelocityContext(VelocityContext context, GenTable genTable) {
        ...
        String subTableFkClassName = CharSequenceUtil.upperFirst(StrUtil.toCamelCase(subTableFkName));
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        if (template.contains("sub-domain.java.vm") && StrUtil.equals(GenConstants.TPL_SUB,
