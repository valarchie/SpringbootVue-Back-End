...
import com.ruoyi.system.domain.test.sys.mapper.SysUserXMapper;
import com.ruoyi.system.domain.test.sys.po.SysRoleDeptXEntity;
import com.ruoyi.system.domain.test.sys.po.SysRoleMenuXEntity;
import com.ruoyi.system.domain.test.sys.po.SysRoleXEntity;
import com.ruoyi.system.domain.test.sys.po.SysUserRoleXEntity;
import com.ruoyi.system.domain.test.sys.service.ISysRoleDeptXService;
import com.ruoyi.system.domain.test.sys.service.ISysRoleMenuXService;
import com.ruoyi.system.domain.test.sys.service.ISysRoleXService;
import com.ruoyi.system.domain.test.sys.service.ISysUserRoleXService;
...
public class SysRoleXServiceImp extends ServiceImpl<SysRoleXMapper, SysRoleXEntity> implements ISysRoleXService {
     ...
     */
    @Override
    public boolean updateRoleDept(SysRole role) {
        // 新增用户与角色管理
        List<SysRoleMenuXEntity> list = new ArrayList<>();
        for (Long menuId : role.getMenuIds()) {
            SysRoleMenuXEntity rm = new SysRoleMenuXEntity();
